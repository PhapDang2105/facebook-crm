...
// Dùng: node tools-intent/merge-labels.mjs <dataset.jsonl> <labels.jsonl> <out.jsonl>
...
const [datasetPath, labelsPath, outPath] = process.argv.slice(2);
...
const stats = { total: rows.length, llmHigh: 0, agree: 0, dropped: 0, noLabel: 0, changed: 0 };
const out = [];
